...
import AmenityInventoryManagerLayout from '@/components/AmenityInventoryManagerLayout';
...
export default function AmenityInventoryPage() {
  ...
  return (
    <AmenityInventoryManagerLayout activePage="amenities">
