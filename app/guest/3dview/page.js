...
export default function GuestThreeDView() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Left Column - Object selection buttons with scrolling */}
        <div 
          className="guest-3dview-sidebar"
          style={{
            width: '320px',
            minWidth: '320px',
            display: 'flex',
